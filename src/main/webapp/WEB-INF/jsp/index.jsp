...
<!-- ============================================ BANNER ========================================================= -->
        ...
        <section>
            <div id="img-bg" style="height: 600px;background-image: url(https://elasticbeanstalk-us-east-1-432335396377.s3.amazonaws.com/Logos/LeituraEmGrupo/pexels-olga-lioncat-7244562.jpg);background-position: center;background-size: cover;">
                    ...
                    <div class="row h-100">
                        <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                            <div id="text-bg" class="shadow p-3" style="max-width: 350px;">
                                ...
                                <p class="my-3" id="font-title" >Seu grupo de leitura sempre organizado e antenado com a comunidade de leitores.</p>
                                ...
                                <c:if test="${not empty usuario}">
                                    ...
                                    <a class="btn btn-outline-light btn-lg" role="button" href="/grupo/listar">Meus grupos</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
...
<!-- ============================================= FEATURES =========================================================== -->
        ...
        <h1>Características</h1>
            <div class="row row-cols-1 row-cols-md-2 ">
                <div class="col ">
                    <img class="rounded w-100 h-100 fit-cover shadow p-3" style="min-height: 300px; border-radius: 10px;" src="https://elasticbeanstalk-us-east-1-432335396377.s3.amazonaws.com/Logos/LeituraEmGrupo/pessoas+lendo.jpg" />
                </div>

                <div class="col d-flex flex-column justify-content-center p-4">
                    <div id="cart" class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5 shadow p-3">
                    ...
                    <div id="cart" class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start shadow p-3">
                        <div class="btn btn-dark" id="icon-bt">
